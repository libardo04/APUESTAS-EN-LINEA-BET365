...
const Nav = () => {
    return (
        ...
        <div className="container px-5">
            <a className="navbar-brand" href="index.html">Apuestas  Bet365</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item dropdown">
                        {/* <a className="nav-link dropdown-toggle" id="navbarDropdownBlog" href="someValidPath" role="button" data-bs-toggle="dropdown" aria-expanded="false">Login</a>
                    ...
                    {/* <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" id="navbarDropdownPortfolio" href="someValidPath" role="button" data-bs-toggle="dropdown" aria-expanded="false">Portfolio</a>
